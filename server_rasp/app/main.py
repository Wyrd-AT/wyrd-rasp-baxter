...
def get_planta_dados(db: Session = Depends(get_db)):
    ...
    """
    # --- LÓGICA DE MAPEAMENTO DOS ANDARES (DA BBRAUN) ---
    ...
    # Estrutura para consolidar os dados (DA BBRAUN)
    dados_andares = {
    ...
    for quarto in quartos_db:
        ...
        # 3. Adiciona o quarto e atualiza o sumário do andar correto (DA BBRAUN)
